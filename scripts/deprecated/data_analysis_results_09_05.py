...
df_156_models = pd.read_excel('./data/processed/final2_melted_df_excel_paired_ALL_model_family.xlsx')
...
#%%
# Plotting Figure 8: Absolute counts of emotion model types and algorithm usage by year
...
df = pd.read_excel('./data/processed/final2_melted_df_excel_paired_ALL.xlsx')
...
#
#print(f"Número de elementos en la lista de bases de datos: {len(list_databases)}")
#
#tabla_2["Citation"] = modelos_metaanalisis["apa_citation"]
#tabla_2["Year"] = modelos_metaanalisis["year"]
#tabla_2["Modelos Machine Learning"] = modelos_metaanalisis["ML_model"]
...
# %%
# Leer data/processed/TABLE_2_incomplete.xlsx
tabla_2 = pd.read_excel("data/processed/TABLE_2_incomplete.xlsx")
